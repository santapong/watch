...
class Detection:
    ...
    depth: float | None = None  # per-detection depth, populated by the depth subsystem
    depth_units: str | None = None  # 'relative' (larger=nearer) | 'metric' (meters, smaller=nearer)
